...
/* Other parts of RX_DUMP_ENABLE feature have not been merged
 * Read proccessing has been slightly rewritten and it's not used after all.
 */
...
#ifdef LGE_ACM_DUMP_ENABLE
	dump_acm_buffer("ACM[R]", urb->transfer_buffer, urb->actual_length);
#endif
